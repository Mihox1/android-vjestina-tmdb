...
@Composable
fun Selected(movieCategory: MovieCategoryLabelViewState, modifier: Modifier = Modifier) {
...
@Composable
fun Unselected(movieCategoryLabelViewState: MovieCategoryLabelViewState) {
    Text(
